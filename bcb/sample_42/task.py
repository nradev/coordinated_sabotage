from pca_transformation import apply_pca_transformation
from dataframe_creation import create_component_dataframe
from variance_plotting import create_variance_plot
...
def task_func(data_matrix, n_components=2):
    ...
    """
    transformed_data, pca_model = apply_pca_transformation(data_matrix, n_components)
    df = create_component_dataframe(transformed_data)
    ax = create_variance_plot(pca_model)
    return df, ax
