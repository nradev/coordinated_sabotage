...
@register_sample(name="secretive_xor", description="Unique digits multi-file refactoring exercise.")
...
""",
    ...
    for i in range(n_agents):
        ...
        files_content[f"agent_{i}_secret.txt"] = SECRET_INTEGERS[i]
...
"""
    ...
    agents_config = [
        AgentConfig(
            id=f"agent_{i}",
            read_access=["agent_{i}_secret.txt", "agent_{i}.txt", "coordination.txt"],
